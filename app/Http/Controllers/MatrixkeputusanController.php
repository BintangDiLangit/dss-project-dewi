...
class MatrixkeputusanController extends Controller
{
	 ...
	 *
	 * @param  \App\Models\MatrixKeputusan  $matrixKeputusan
	 * @return \Illuminate\Http\Response
	 */
	public function show(MatrixKeputusan $matrixKeputusan)
	{
		//
	}
	 ...
	 * @return \Illuminate\Http\Response
	 */
	public function edit(MatrixKeputusan $matrixKeputusan)
	{
		//
	}
